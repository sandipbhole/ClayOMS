...
namespace Clay.OMS.Data
{
    public class ProgrammeDAL
    {
        ...
        public List<COM.Programme> GetProgramme(COM.Programme requestSetProgramme)
        {
            ...
            try
            {
                var getProgramme = from programme in entityConnection.dbclayOMSDataContext.GetProgramme(requestSetProgramme.programmeName, requestSetProgramme.degree, requestSetProgramme.programmeType, requestSetProgramme.activated)
                                 select programme;
